	...
	<div class="wrap">
		...
		<div class="dl-grid">
			<motion.div class="dl-card liquid-glass" {...fadeUp(0)}>
				...
				<p class="dl-note">
					One-click installer. The setup wizard installs ComfyUI, Python 3.11, and PyTorch on
					first launch. No manual configuration needed.
				</p>
				<a class="btn btn-primary" href={winUrl}>
					<Icon name="download" />
					Download .exe
				</a>
			</motion.div>
			...
			<motion.div class="dl-card liquid-glass" {...fadeUp(0.1)}>
				<div class="dl-os">
					<span class="osicon">
						<!-- Tux (Linux) -->
						<svg width="26" height="26" viewBox="0 0 304.998 304.998" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
				...
				<p class="dl-note">
					AppImage runs anywhere without installation. The .deb integrates with apt on
					Ubuntu/Debian-based systems.
				</p>
				<div class="btn-row">
					<a class="btn btn-primary" href={appimageUrl}>
						<Icon name="download" />
						AppImage
					</a>
					<a class="btn btn-secondary" href={debUrl}>
						.deb
					</a>
				</div>
			</motion.div>
